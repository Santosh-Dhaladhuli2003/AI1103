...
\sigma^2(Y) &= E((Y - E(Y))^2) = 0 \\
            &= \Sigma(Y - E(Y))^{2}\pr{X} \\
            (Y - E(Y))^{2} &\ge 0 \text{ and} \pr{X} \ge 0 
\end{align*}
Since each term inside summation are non-negative \\
For summation to be 0,term in it must be 0, 
\begin{align*}
\implies (Y - E(Y))^{2} &= 0
  \implies Y = E(Y) \\
  \tag{*}
...
\end{align*} 
\begin{center}
     \boxed{\text{\textbf{Option 1} is a \textbf{correct} answer}}
\end{center}
\vspace{0.8cm}
...
\end{align*}
\begin{center}
    \boxed{\text{\textbf{Option 2} is a \textbf{correct} answer}}
\end{center}
\vspace{0.1cm}
...
\vspace{0.3cm}
\begin{center}
    \boxed{\text{\textbf{Option 3} is a \textbf{WRONG} answer}}
\end{center}
\vspace{0.3cm}
...
\end{enumerate}
\vspace{0.5cm}
\centering \boxed{\text{So, only Options \textbf{1, 2 and 4} are correct}}
\end{document}
