...
$\therefore$ We Define, X $\in$ {{0,1}} \\
$\pr{X = 0} \longrightarrow$ denotes for 52 Saturdays \\
$\pr{X = 1} \longrightarrow$ denotes for 53 Saturdays \\
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{Assignment 2 AI1103.png}
\end{figure}
\end{document}
