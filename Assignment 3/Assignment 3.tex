...
Let $A_{1} \cup A_{2} \cup A_{3} .... \cup A_{n}$ = S, \\
$\pr{S}$ = Probability of atleast one event occuring
De morgan's law states that $(A \cup B)^\complement = A^\complement \cap B^\complement$  
\begin{align}
    \tag{1.1}
   \implies \pr{S} = 1 - \pr{S^\complement} \\ 
   \tag{1.2}
   1 - \pr{S^\complement}= 1 - \pr{A_{1}^\complement \cap A_{2}^\complement \cap A_{3}^\complement \cap....A_{n}^\complement}
\end{align}
Since,$A_{1},A_{2},.....A_{n}$ are independent.Complements of $A_{1},A_{2},.....A_{n}$ are also independent. \\
$\implies$ 
\begin{equation}
\tag{2.1}
\pr{A_{1}^\complement \cap A_{2}^\complement \cap....A_{n}^\complement} = \pr{A_{1}^\complement} \times \pr{A_{2}^\complement} ...\times\pr{A_{n}^\complement}
\end{equation}
\begin{equation}
    \tag{2.2}
\pr{A_{i}} = 1 - \frac{1}{\alpha^i} \implies \pr{A_{1}^\complement} = \frac{1}{\alpha^i}
\end{equation}
\begin{equation}
    \tag{2.3}
