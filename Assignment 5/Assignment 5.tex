...
\begin{lstlisting}
https://github.com/Santosh-Dhaladhuli2003/AI1103/blob/main/Assignment%205/assignment_5.py
\end{lstlisting}
%
...
\begin{align}
    \pr{X > 5} =  \lim_{x\to\infty} \int_{5}^{x} \frac{1}{5}e^{-\frac{x}{5}} \,dx \\
   \implies  \lim_{x\to\infty} \brak{-e^{- \frac{x}{5}}} \Bigg|_5^x \\
   \implies \lim_{x\to\infty} \brak{-e^{- \frac{x}{5}} + \frac{1}{e}} \\
   \therefore \pr{X > 5} = \frac{1}{e}
\end{align}

\begin{figure}[!htb]
    \centering
    \includegraphics[width = 0.5\textwidth]{Exp Assignment 5.png}
    \label{EXP}
\end{figure}
\end{document}
